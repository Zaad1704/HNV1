...
const PropertiesPage = () => {
            ...
            <div className="overflow-x-auto">
                <table className="w-full text-left">
                    <thead className="bg-light-bg dark:bg-dark-bg/50 border-b border-border-color dark:border-border-color-dark">
                        <tr>
                            <th className="p-4 text-sm font-semibold text-light-text dark:text-light-text-dark uppercase">Property Name</th>
                            <th className="p-4 text-sm font-semibold text-light-text dark:text-light-text-dark uppercase">Address</th>
                            <th className="p-4 text-sm font-semibold text-light-text dark:text-light-text-dark uppercase">Units</th>
                    ...
                    <tbody className="divide-y divide-border-color dark:divide-border-color-dark">
                        {filteredProperties.map((prop: any) => (
                            <tr key={prop._id} className="hover:bg-light-bg dark:hover:bg-dark-bg/40 transition-colors duration-150">
    ...
    const MobileView = () => (
        <div className="grid grid-cols-1 gap-4">
            {filteredProperties.map((prop: any) => (
                <div key={prop._id} className="bg-light-card dark:bg-dark-card p-4 rounded-xl border border-border-color dark:border-border-color-dark shadow-sm transition-all duration-200" onClick={() => navigate(`/dashboard/properties/${prop._id}`)}>
        ...
        <div className="text-dark-text dark:text-dark-text-dark">
            ...
            <div className="relative mb-6">
                ...
                <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-light-card dark:bg-dark-card border border-border-color dark:border-border-color-dark rounded-lg text-dark-text dark:text-dark-text-dark focus:ring-brand-primary focus:border-brand-primary transition-all duration-200"
                />
            </div>
