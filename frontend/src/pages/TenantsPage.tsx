...
const TenantsPage = () => {
    ...
    return (
        ...
        >
            ...
            <div className="p-4 bg-light-card rounded-3xl border border-border-color mb-6 dark:bg-dark-card dark:border-border-color-dark">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-end">
                    <div className="lg:col-span-1">
                        ...
                        <div className="relative">
                            ...
                            <input type="text" placeholder="Name, email, or unit..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full pl-10 pr-4 py-3" />
                        </div>
                    </div>
                    <div className="lg:col-span-1">
                        ...
                        <select
                            ...
                            className="w-full h-[50px] px-4 py-3"
                        >
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                             ...
                             <button onClick={handleExport} className="btn-primary flex-shrink-0" title="Export as CSV">
                                <Download size={18} />
                                <span>CSV</span>
                            </button>
                        </div>
                        ...
                        <table className="w-full text-left">
                            ...
                            <tbody className="divide-y divide-border-color dark:divide-border-color-dark">
                                {filteredTenants.map((tenant: ITenant) => (
                                    <tr key={tenant._id} className="hover:bg-light-bg/50 dark:hover:bg-dark-bg/40">
