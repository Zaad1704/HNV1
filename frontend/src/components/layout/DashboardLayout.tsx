...
import { Home, Building, Users, CreditCard, Shield, Settings, LogOut, Star, Menu, X, FileText, Wrench } from 'lucide-react'; // <-- Import Wrench icon
...
const DashboardLayout = () => {
  ...
  const getLinkClass = (path: string) => {
    if (path === '/dashboard/overview') {
        return location.pathname === path ? 'bg-yellow-500 text-slate-900' : 'text-slate-300 hover:bg-slate-700 hover:text-white';
    }
