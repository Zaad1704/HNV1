...
export default function AboutSection() {
  ...
  const { translatedText: translatedTitle } = useDynamicTranslation(settings?.aboutPage?.title || 'About HNV Property Managegment Solutions');
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="rounded-lg overflow-hidden shadow-xl">
            <img
              // NEW: Use image from SiteSettings for the main About page image
          ...
          <div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed dark:text-light-text-dark">
                {translatedVisionStatement}
              </p>
            </div>
          </div>
        </div>
        <div className="mt-20">
            <h2 className="text-3xl font-bold text-center text-dark-text dark:text-dark-text-dark">{translatedTeamTitle}</h2>
            <p className="text-light-text mt-4 max-w-2xl mx-auto text-center dark:text-light-text-dark">{translatedTeamSubtitle}</p>
