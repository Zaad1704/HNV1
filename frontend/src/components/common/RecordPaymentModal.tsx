// frontend/src/components/common/RecordPaymentModal.tsx
      ...
      <div className="bg-light-card dark:bg-dark-card rounded-3xl shadow-xl w-full max-w-lg border border-border-color dark:border-border-color-dark">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[85vh] overflow-y-auto">
          ...
          <div>
            ...
            <select name="tenantId" id="tenantId" required value={formData.tenantId} onChange={handleChange} disabled={isLoading}>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="number" step="0.01" name="amount" id="amount" required value={formData.lineItems.length > 0 ? formData.totalCalculatedAmount.toFixed(2) : formData.amount} onChange={handleChange} disabled={formData.lineItems.length > 0}/>
            </div>
            <div>
              ...
              <input type="date" name="paymentDate" id="paymentDate" required value={formData.paymentDate} onChange={handleChange}/>
            </div>
          </div>
