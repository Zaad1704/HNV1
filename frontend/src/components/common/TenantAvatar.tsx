  ...
  return (
    <div className={`relative ${className}`}>
      <div className={`${sizeClasses[size]} rounded-full overflow-hidden flex items-center justify-center relative`}>
        ...
        <div className={`avatar-fallback w-full h-full bg-gradient-to-br ${getGradientClass(tenant.name || 'T')} flex items-center justify-center text-white font-bold ${tenant.imageUrl || tenant.tenantImage ? 'hidden' : ''}`}>
