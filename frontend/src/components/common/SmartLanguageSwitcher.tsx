      ...
      <div className="relative">
        ...
        {showAll && (
          <>
            ...
            <div className="absolute top-full mt-2 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 z-[9999] overflow-hidden max-h-80 overflow-y-auto transform scale-90 md:scale-100" style={{right: '0', left: 'auto', maxWidth: 'min(224px, calc(100vw - 2rem))', transform: 'translateX(-90%)'}}>
              <div className="p-1">
