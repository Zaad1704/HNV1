  ...
  return (
    <Router>
      <Routes>
        ...
        {/* The DashboardLayout will wrap all pages inside this route */}
        <Route path="/" element={<ProtectedRoute />}>
            <Route path="dashboard" element={<DashboardLayout />}>
                <Route index element={<DashboardPage />} />
                {/* Add other dashboard pages here if they should use the layout */}
            </Route>
            {/* These routes are protected but don't use the main dashboard layout */}
