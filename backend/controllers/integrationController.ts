...
export const updateIntegration: asyncHandler(async (req : Request, res: Response))): Promise<void> => { const { id: req.params;
...
const { query, filters: {
}, sort: 'date_desc', page: 1, limit: 20 } = req.query;
...
export const searchSuggestions: asyncHandler(async (req : Request, res: Response))): Promise<void> => { const { query, type: req.query;
