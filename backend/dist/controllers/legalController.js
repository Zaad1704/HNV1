...
Last updated: ${new Date().toLocaleDateString()}
  `;
    const htmlContent = (0, marked_1.marked)(termsMarkdown);
    res.json({
        success: true,
        data: {
            content: htmlContent,
...
exports.getPrivacyPolicy = (0, express_async_handler_1.default)(async (req, res) => {
...
Last updated: ${new Date().toLocaleDateString()}
  `;
    const htmlContent = (0, marked_1.marked)(privacyMarkdown);
    res.json({
        success: true,
        data: {
            content: htmlContent,
