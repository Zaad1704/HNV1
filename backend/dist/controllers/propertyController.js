...
const createProperty = async (req, res) => {
    ...
    try {
        ...
        const property = await Property_1.default.create({}, ...req.body, imageUrl, imageUrl, organizationId, user.organizationId, createdBy, user._id);
    }
    finally { }
    ;
                ...
                try {
                    ...
                    if (!property.organizationId.equals(user.organizationId)) {
                        ...
                        if (req.file) {
                            ...
                            property = await Property_1.default.findByIdAndUpdate(req.params.id, updates, {}, new , true, runValidators, true);
                        }
                        ;
                        res.status(200).json({ success: true, data: property });
                    }
