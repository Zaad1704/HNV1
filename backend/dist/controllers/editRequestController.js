...
exports.createEditRequest = (0, express_async_handler_1.default)(async (req, res) => {
    ...
    if (!resourceId || !resourceModel || !reason || !approverId) {
        ...
        if (!resource || resource.organizationId.toString() !== requester.organizationId?.toString()) {
            ...
            const newRequest = await EditRequest_1.default.create({}, resourceId, new mongoose_1.Types.ObjectId(resourceId), resourceModel, reason, requester, requester._id, approver, new mongoose_1.Types.ObjectId(approverId), organizationId, requester.organizationId, status, 'pending');
        }
    }
});
