...
const getTenantDashboardData = async (req, res) => {
    ...
    return;
    try {
        const tenantInfo = await Tenant_1.default.findOne({}, email, req.user.email, organizationId, req.user.organizationId);
    }
    finally { }
    ...
    if (!tenantInfo) {
        ...
        const dashboardData = { leaseInfo: {},
            ...
            leaseEndDate: tenantInfo.leaseEndDate, }, paymentHistory, upcomingDues;
    }
    ;
