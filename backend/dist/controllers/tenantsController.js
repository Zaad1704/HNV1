...
const createTenant = async (req, res) => {
    try {
        ...
        auditService_1.default.recordAction(req.user._id, req.user.organizationId, 'TENANT_CREATE', {
...
const updateTenant = async (req, res) => {
    try {
        ...
        if (updatedTenant) {
            ...
            auditService_1.default.recordAction(req.user._id, req.user.organizationId, 'TENANT_UPDATE', {
...
const deleteTenant = async (req, res) => {
    try {
        ...
        auditService_1.default.recordAction(req.user._id, req.user.organizationId, 'TENANT_DELETE', { tenantId: tenant._id.toString(), tenantName: tenant.name });
